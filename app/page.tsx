  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        body: "Led PyTorch algorithm and model-architecture design for multimodal image fusion, including data integration, iterative tuning, and experiment planning across a four-person research team.",
  ...
  zh: {
    ...
    projects: [
      ...
      },
      {
        ...
        body: "负责基于 PyTorch 的多模态图像融合算法与模型架构设计，覆盖数据整合、迭代调优，并协调四人团队完成实验规划与研究写作。",
